...
func TestExtractTitle(t *testing.T) {
	tests := []struct {
		...
		{"frontmatter ~~~", "~~~\ntitle: foo\n~~~\n# Tilde Title", "Tilde Title"},
		{"frontmatter ```", "```\ntitle: foo\n```\n# Backtick Title", "Backtick Title"},
		{"frontmatter with comment-like line", "---\n# comment in yaml\ntitle: foo\n---\n# Real Title", "Real Title"},
		{"unclosed frontmatter", "---\ntitle: foo\n# Fallback Title", "Fallback Title"},
		{"mismatched delimiters", "---\ntitle: foo\n~~~\n# Fallback Title", "Fallback Title"},
		{"closing fence with spaces", "---\ntitle: foo\n  ---  \n# Spaced Fence", "Spaced Fence"},
		{"frontmatter only no body", "---\ntitle: foo\n---", ""},
		{"crlf line endings", "---\r\ntitle: foo\r\n---\r\n# CRLF Title", "CRLF Title"},
		{"no heading after frontmatter", "---\ntitle: foo\n---\nJust text", ""},
		{"frontmatter with BOM", "\xef\xbb\xbf---\ntitle: foo\n---\n# BOM Title", "BOM Title"},
		...
		{"hashtag line", "#hashtag is not a heading", ""},
		{"h7 invalid", "####### Too Deep", ""},
		{"h6 valid", "###### Deep But Valid", "Deep But Valid"},
		{"3 spaces indent", "   # Three Spaces", "Three Spaces"},
		{"4 spaces indent (code block)", "    # Four Spaces", ""},
		{"tab indent", "\t# Tab Indent", ""},
		{"trailing hashes stripped", "# Title ##", "Title"},
		{"trailing hashes with spaces", "# Title  ###  ", "Title"},
